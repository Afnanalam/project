...
jQuery(document).ready(function ($) {
			...
			var jssor_slider1 = new $JssorSlider$("slider1_container4", options);
		    var jssor_slider1 = new $JssorSlider$("slider1_container5", options);
			var jssor_slider1 = new $JssorSlider$("slider1_container6", options);
			
			var jssor_slider1 = new $JssorSlider$("slider1_container7", options);
		    var jssor_slider1 = new $JssorSlider$("slider1_container8", options);
			var jssor_slider1 = new $JssorSlider$("slider1_container9", options);
			
			var jssor_slider1 = new $JssorSlider$("slider1_container10", options);
